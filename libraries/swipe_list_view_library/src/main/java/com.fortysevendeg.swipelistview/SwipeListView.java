...
public class SwipeListView extends ListView {
    ...
    */
    ...
    public SwipeListView(Context context, int swipeBackView, int swipeFrontView) {
        super(context);
        System.err.println("Inside SwipeListView() of SwipeListView.java");
        System.err.println("swipeFrontView parameter inside constructor= "+ swipeFrontView);
        this.swipeFrontView = swipeFrontView;
        System.err.println("this.swipeFrontView of class inside constructor= "+ this.swipeFrontView);
    ...
    public SwipeListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        System.err.println("Inside SwipeListView2() of SwipeListView.java");
        init(attrs);
    }
    ...
    public SwipeListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        System.err.println("Inside SwipeListView3() of SwipeListView.java");
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        System.err.println("Inside init() of SwipeListView.java");
        ...
        //The bottom if(attrs !=null) initializes all the attribute definitions found inside the custom
        //<com.fortysevendeg.swipelistview.SwipeListView inside main_activity.xml
        //For example, swipe:swipeFrontView, swipeBackView, swipeDrawableChecked,
        //swipeDrawableUnchecked, swipeCloseAllItemsWhenMoveList, and swipeMode
        //Each of the variables inside swipelistview_attrs.xml has a prefix that starts with
        //"SwipeListView_", then followed by the variable's name.
        if (attrs != null) {
            ...
            System.err.println("swipeFrontView inside init()= "+ swipeFrontView);
            swipeBackView = styled.getResourceId(R.styleable.SwipeListView_swipeBackView, 0);
            System.err.println("swipeBackView= "+ swipeBackView);
            styled.recycle();
        }

        System.err.println("Before if(swipeFrontView==)");
        if (swipeFrontView == 0 || swipeBackView == 0) {
            System.err.println("Inside if(swipeFrontView==0). swipeFrontView= "+ swipeFrontView);
    ...
    public void recycle(View convertView, int position) {
        System.err.println("Inside recycle() of SwipeListView.java");
    ...
    public boolean isChecked(int position) {
        System.err.println("Inside isChecked() of SwipeListView.java");
    ...
    public List<Integer> getPositionsSelected() {
        System.err.println("Inside getPositionSelected() of SwipeListView.java");
    ...
    public int getCountSelected() {
        System.err.println("Inside getCountSelected() of SwipeListView.java");
    ...
    public void unselectedChoiceStates() {
        System.err.println("Inside unselectedChoiceStates() of SwipeListView.java");
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        System.err.println("Inside setAdapter() of SwipeListView.java");
    ...
    public void dismiss(int position) {
        System.err.println("Inside dismiss() of SwipeListView.java");
    ...
    public void dismissSelected() {
        System.err.println("Inside dismissSelected() of SwipeListView.java");
    ...
    public void openAnimate(int position) {
        System.err.println("Inside openAnimate() of SwipeListView.java");
    ...
    public void closeAnimate(int position) {
        System.err.println("Inside closeAnimate() of SwipeListView.java");
    ...
    protected void onDismiss(int[] reverseSortedPositions) {
        System.err.println("Inside onDismiss() of SwipeListView.java");
    ...
    protected void onStartOpen(int position, int action, boolean right) {
        System.err.println("Inside onStartOpen() of SwipeListView.java");
    ...
    protected void onStartClose(int position, boolean right) {
        System.err.println("Inside onStartClose() of SwipeListView.java");
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
    ...
    protected void onClickFrontView(int position) {
        System.err.println("Inside onClickFrontView() of SwipeListView.java");
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
    ...
    protected void onClickBackView(int position) {
        System.err.println("Inside onClickBackView() of SwipeListView.java");
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
    ...
    protected void onOpened(int position, boolean toRight) {
        System.err.println("Inside onOpened() of SwipeListView.java");
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
    ...
    protected void onClosed(int position, boolean fromRight) {
        System.err.println("Inside onClosed() of SwipeListView.java");
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
    ...
    protected void onChoiceChanged(int position, boolean selected) {
        System.err.println("Inside onChoiceChanged() of SwipeListView.java");
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
    ...
    protected void onChoiceStarted() {
        System.err.println("Inside onChoiceStarted() of SwipeListView.java");
        if (swipeListViewListener != null) {
    ...
    protected void onChoiceEnded() {
        System.err.println("Inside onChoiceEnded() of SwipeListView.java");
        if (swipeListViewListener != null) {
    ...
    protected void onFirstListItem() {
        System.err.println("Inside onFirstListItem() of SwipeListView.java");
        if (swipeListViewListener != null) {
    ...
    protected void onLastListItem() {
        System.err.println("Inside onLastListItem() of SwipeListView.java");
        if (swipeListViewListener != null) {
    ...
    protected void onListChanged() {
        System.err.println("Inside onListChanged() of SwipeListView.java");
        if (swipeListViewListener != null) {
    ...
    protected void onMove(int position, float x) {
        System.err.println("Inside onMove() of SwipeListView.java");
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
    ...
    protected int  changeSwipeMode(int position) {
        System.err.println("Inside changeSwipeMode() of SwipeListView.java");
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
    ...
    public void setSwipeListViewListener(SwipeListViewListener swipeListViewListener) {
        System.err.println("Inside setSwipeListViewListener() of SwipeListView.java");
    ...
    public void resetScrolling() {
        System.err.println("Inside resetScrolling() of SwipeListView.java");
    ...
    public void setOffsetRight(float offsetRight) {
        System.err.println("Inside setOffsetRight() of SwipeListView.java");
    ...
    public void setOffsetLeft(float offsetLeft) {
        System.err.println("Inside setOffsetLeft() of SwipeListView.java");
    ...
    public void setSwipeCloseAllItemsWhenMoveList(boolean swipeCloseAllItemsWhenMoveList) {
        System.err.println("Inside setSwipeCloseAllItemsWhenMoveList() of SwipeListView.java");
        touchListener.setSwipeClosesAllItemsWhenListMoves(swipeCloseAllItemsWhenMoveList);
    }
    ...
    public void setSwipeOpenOnLongPress(boolean swipeOpenOnLongPress) {
        System.err.println("Inside setSwipeOpenOnLongPress() of SwipeListView.java");
        touchListener.setSwipeOpenOnLongPress(swipeOpenOnLongPress);
    }
    ...
    public void setSwipeMode(int swipeMode) {
        System.err.println("Inside setSwipeMode() of SwipeListView.java");
        touchListener.setSwipeMode(swipeMode);
    }
    ...
    public int getSwipeActionLeft() {
        System.err.println("Inside getSwipeActionLeft() of SwipeListView.java");
    ...
    public void setSwipeActionLeft(int swipeActionLeft) {
        System.err.println("Inside setSwipeActionLeft() of SwipeListView.java");
        touchListener.setSwipeActionLeft(swipeActionLeft);
    }
    ...
    public int getSwipeActionRight() {
        System.err.println("Inside getSwipeActionRight() of SwipeListView.java");
    ...
    public void setSwipeActionRight(int swipeActionRight) {
        System.err.println("Inside setSwipeActionRight() of SwipeListView.java");
        touchListener.setSwipeActionRight(swipeActionRight);
    }
    ...
    public void setAnimationTime(long animationTime) {
        System.err.println("Inside setAnimationTime() of SwipeListView.java");
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        System.err.println("Inside onInterceptTouchEvent() of SwipeListView.java");
    ...
    private void checkInMoving(float x, float y) {
        System.err.println("Inside checkInMoving() of SwipeListView.java");
    ...
    public void closeOpenedItems() {
        System.err.println("Inside closeOpenedItems() of SwipeListView.java");
