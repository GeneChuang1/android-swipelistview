...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    private int swipeMode = com.fortysevendeg.swipelistview.SwipeListView.SWIPE_MODE_BOTH;
    ...
    public SwipeListViewTouchListener(SwipeListView swipeListView, int swipeFrontView, int swipeBackView) {
        System.err.println("Inside constructor1() of SwipeListViewTouchListener.java");
    ...
    private void setParentView(View parentView) {
        System.err.println("Inside setParentView() of SwipeListViewTouchListener.java");
    ...
    private void setFrontView(View frontView, final int childPosition) {
        System.err.println("Inside setFrontView() of SwipeListViewTouchListener.java");
    ...
    private void setBackView(View backView) {
        System.err.println("Inside setBackView() of SwipeListViewTouchListener.java");
    ...
    public boolean isListViewMoving() {
        System.err.println("Inside isListViewMoving() of SwipeListViewTouchListener.java");
    ...
    public void setAnimationTime(long animationTime) {
        System.err.println("Inside setAnimationTime() of SwipeListViewTouchListener.java");
        if (animationTime > 0) {
    ...
    public void setRightOffset(float rightOffset) {
        System.err.println("Inside setRightOffset() of SwipeListViewTouchListener.java");
    ...
    public void setLeftOffset(float leftOffset) {
        System.err.println("Inside setLeftOffset() of SwipeListViewTouchListener.java");
    ...
    public void setSwipeClosesAllItemsWhenListMoves(boolean swipeClosesAllItemsWhenListMoves) {
        System.err.println("Inside setSwipeClosesAllItemsWhenListMoves() of SwipeListViewTouchListener.java");
    ...
    public void setSwipeOpenOnLongPress(boolean swipeOpenOnLongPress) {
        System.err.println("Inside setSwipeOpenOnLongPress() of SwipeListViewTouchListener.java");
    ...
    public void setSwipeMode(int swipeMode) {
        System.err.println("Inside setSwipeMode() of SwipeListViewTouchListener.java");
    ...
    protected boolean isSwipeEnabled() {
        System.err.println("Inside isSwipeEnabled() of SwipeListViewTouchListener.java");
    ...
    public int getSwipeActionLeft() {
        System.err.println("Inside getSwipeActionLeft() of SwipeListViewTouchListener.java");
    ...
    public void setSwipeActionLeft(int swipeActionLeft) {
        System.err.println("Inside setSwipeActionLeft() of SwipeListViewTouchListener.java");
    ...
    public int getSwipeActionRight() {
        System.err.println("Inside getSwipeActionRight() of SwipeListViewTouchListener.java");
    ...
    public void setSwipeActionRight(int swipeActionRight) {
        System.err.println("Inside setSwipeActionRight() of SwipeListViewTouchListener.java");
    ...
    protected void setSwipeDrawableChecked(int swipeDrawableChecked) {
        System.err.println("Inside setSwipeDrawableChecked() of SwipeListViewTouchListener.java");
    ...
    protected void setSwipeDrawableUnchecked(int swipeDrawableUnchecked) {
        System.err.println("Inside setSwipeDrawableUnchecked() of SwipeListViewTouchListener.java");
    ...
    public void resetItems() {
        System.err.println("Inside resetItems() of SwipeListViewTouchListener.java");
    ...
    protected void openAnimate(int position) {
        System.err.println("Inside openAnimate() of SwipeListViewTouchListener.java");
    ...
    protected void closeAnimate(int position) {
        System.err.println("Inside closeAnimate() of SwipeListViewTouchListener.java");
    ...
    private void swapChoiceState(int position) {
        System.err.println("Inside swapChoiceState() of SwipeListViewTouchListener.java");
    ...
    protected void unselectedChoiceStates() {
        System.err.println("Inside unselectedChoiceStates() of SwipeListViewTouchListener.java");
    ...
    protected int dismiss(int position) {
        System.err.println("Inside dismiss() of SwipeListViewTouchListener.java");
    ...
    protected void reloadChoiceStateInView(View frontView, int position) {
        System.err.println("Inside reloadChoiceStateInView() of SwipeListViewTouchListener.java");
    ...
    protected void reloadSwipeStateInView(View frontView, int position) {
        System.err.println("Inside reloadSwipeStateInView() of SwipeListViewTouchListener.java");
    ...
    protected boolean isChecked(int position) {
        System.err.println("Inside isChecked() of SwipeListViewTouchListener.java");
    ...
    protected int getCountSelected() {
        System.err.println("Inside getCountSelected() of SwipeListViewTouchListener.java");
        int count = 0;
        for (int i = 0; i < checked.size(); i++) {
            if (checked.get(i)) {
                count++;
    ...
    protected List<Integer> getPositionsSelected() {
        System.err.println("Inside getPositionsSelected() of SwipeListViewTouchListener.java");
    ...
    private void generateAnimate(final View view, final boolean swap, final boolean swapRight, final int position) {
        System.err.println("Inside generateAnimate() of SwipeListViewTouchListener.java");
        if(SwipeListView.DEBUG){
    ...
    private void generateChoiceAnimate(final View view, final int position) {
        System.err.println("Inside generateChoiceAnimate() of SwipeListViewTouchListener.java");

        //I'm not sure what the bottom animate() does
        animate(view)
                .translationX(0)
    ...
    private void generateDismissAnimate(final View view, final boolean swap, final boolean swapRight, final int position) {
        System.err.println("Inside generateDismissAnimate() of SwipeListViewTouchListener.java");
        int moveTo = 0;
        if (opened.get(position)) {
            if (!swap) {
     ...
     *                  If swap= true, then the ListView item is not opened and should be opened.
     *                  If swap=false, then the item is already opened and should be closed.
    ...
    private void generateRevealAnimate(final View view, final boolean swap, final boolean swapRight, final int position) {
        System.err.println("Inside generateRevealAnimate() of SwipeListViewTouchListener.java");
        int moveTo = 0; //moveTo determines how far to move the front view.
        //If moveTo is negative, it moves left. If positive, it moves right.

        //The entire openedRight ArrayList is set to false;
//---------Start of Gene's Test-----------------------
        //openedRight.set(3, true);
        //System.out.println("swap= "+ swap);
//---------End of Gene's Test-----------------------

        if (opened.get(position)) { //Sees if the ListView item is already opened
            if (!swap) {  //If ListView item is already opened.
                moveTo = openedRight.get(position) ? (int) (viewWidth - rightOffset) : (int) (-viewWidth + leftOffset);
                //(viewWidth - rightOffset)= Moves the front view to the right. (Closes the front view)
                //(-viewWidth + leftOffset)= Moves the front view to the left.
/*                System.out.println("moveTo1= "+ moveTo);
                System.out.println("openedRight.get(position)= "+ openedRight.get(position));
                System.out.println("viewWidth= "+ viewWidth);
                System.out.println("rightOffset= "+ rightOffset);
                System.out.println("leftOffset= "+ leftOffset);
*/            }
        } else {
            if (swap) {  //If not opened.
                moveTo = swapRight ? (int) (viewWidth - rightOffset) : (int) (-viewWidth + leftOffset);
/*                System.out.println("moveTo2= "+ moveTo);
                System.out.println("swapRight= "+ swapRight);
                System.out.println("viewWidth= "+ viewWidth);
                System.out.println("rightOffset= "+ rightOffset);
                System.out.println("leftOffset= "+ leftOffset);
*/            }
...
//---------Start of Gene's Test-----------------------
        //moveTo= -110;
        //for (int i=0; i!= openedRight.size();i++){
        //    System.out.println("openedRight.get("+i+")= "+ openedRight.get(i));
        //}

//---------End of Gene's Test-----------------------

        //The bottom animate() pops the front view back in place when user moves the view
        // a certain amount.
        animate(view)
                .translationX(moveTo)
                .setDuration(animationTime)
    ...
    private void resetCell() {
        System.err.println("Inside resetCell() of SwipeListViewTouchListener.java");
    ...
    public void setEnabled(boolean enabled) {
        System.err.println("Inside setEnabled() of SwipeListViewTouchListener.java");
        paused = !enabled;
    }
    ...
    public AbsListView.OnScrollListener makeScrollListener() {
        System.err.println("Inside makeScrollListener() of SwipeListViewTouchListener.java");
        return new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView absListView, int scrollState) {
                System.err.println("Inside onScrollStateChanged() of SwipeListViewTouchListener.java");
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                System.err.println("Inside onScroll() of SwipeListViewTouchListener.java");
                if (isFirstItem) {
    ...
    void closeOpenedItems() {
        System.err.println("Inside closeOpenedItems() of SwipeListViewTouchListener.java");
        if (opened != null) {
            int start = swipeListView.getFirstVisiblePosition();
            int end = swipeListView.getLastVisiblePosition();
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        System.err.println("Inside onTouch() of SwipeListViewTouchListener.java");
        if (!isSwipeEnabled()) {
            return false;
        }
    ...
    private void setActionsTo(int action) {
        System.err.println("Inside setActionsTo() of SwipeListViewTouchListener.java");
    ...
    protected void returnOldActions() {
        System.err.println("Inside returnOldActions() of SwipeListViewTouchListener.java");
    ...
    public void move(float deltaX) {
        System.err.println("Inside move() of SwipeListViewTouchListener.java");
    ...
    class PendingDismissData implements Comparable<PendingDismissData> {
        ...
        public PendingDismissData(int position, View view) {
            System.err.println("Inside PendingDismissData() of SwipeListViewTouchListener.java's nested PendingDismissData class");
        ...
        public int compareTo(PendingDismissData other) {
            System.err.println("Inside compareTo() of SwipeListViewTouchListener.java's nested PendingDismissData class");
    ...
    protected void performDismiss(final View dismissView, final int dismissPosition, boolean doPendingDismiss) {
        System.err.println("Inside performDismiss() of SwipeListViewTouchListener.java");
    ...
    protected void resetPendingDismisses() {
        System.err.println("Inside resetPendingDismisses() of SwipeListViewTouchListener.java");
    ...
    protected void handlerPendingDismisses(final int originalHeight) {
        System.err.println("Inside handlerPendingDismisses() of SwipeListViewTouchListener.java");
    ...
    private void removePendingDismisses(int originalHeight) {
        System.err.println("Inside removePendingDismisses() of SwipeListViewTouchListener.java");
    ...
    public static void enableDisableViewGroup(ViewGroup viewGroup, boolean enabled) {
        System.err.println("Inside enableDisableViewGroup() of SwipeListViewTouchListener.java");
